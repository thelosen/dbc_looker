...
#   sql_table_name: mysql_heroku_app_db.shop_orders ;;
  ...
  dimension: is_before_mtd {
    type: yesno
    sql:
      (EXTRACT(DAY FROM CONVERT_TZ(${TABLE}.created_at,'UTC','PST') < EXTRACT(DAY FROM CONVERT_TZ(GETDATE(),'UTC','PST'))
       OR
      (EXTRACT(DAY FROM CONVERT_TZ(${TABLE}.created_at,'UTC','PST') = EXTRACT(DAY FROM CONVERT_TZ(GETDATE(),'UTC','PST')) AND
      EXTRACT(HOUR FROM CONVERT_TZ(${TABLE}.created_at,'UTC','PST') < EXTRACT(HOUR FROM CONVERT_TZ(GETDATE(),'UTC','PST')))
      OR
      (EXTRACT(DAY FROM CONVERT_TZ(${TABLE}.created_at,'UTC','PST') = EXTRACT(DAY FROM CONVERT_TZ(GETDATE(),'UTC','PST')) AND
      EXTRACT(HOUR FROM CONVERT_TZ(${TABLE}.created_at,'UTC','PST') <= EXTRACT(HOUR FROM CONVERT_TZ(GETDATE(),'UTC','PST')) AND
      EXTRACT(MINUTE FROM CONVERT_TZ(${TABLE}.created_at,'UTC','PST') < EXTRACT(MINUTE FROM CONVERT_TZ(GETDATE(),'UTC','PST')))
      );;
  }
