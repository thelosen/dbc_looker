...
view: combination_5 {
  derived_table: {
    ...
    sql:
   SELECT product.sku, product_1.sku as combo_sku, product_2.sku as combo_sku_2, product_3.sku as combo_sku_3, product_4.sku as combo_sku_4, product_5.sku as combo_sku_5, shop_order_items.order_id


    FROM ((((((((((mysql_heroku_app_db.shop_order_items

    INNER JOIN mysql_heroku_app_db.shop_order_items AS shop_order_items_1 ON (shop_order_items.order_id = shop_order_items_1.order_id AND shop_order_items.product_id < shop_order_items_1.product_id))
    ...
    INNER JOIN mysql_heroku_app_db.shop_order_items AS shop_order_items_5 ON (shop_order_items_1.order_id = shop_order_items_5.order_id AND shop_order_items.product_id < shop_order_items_5.product_id AND shop_order_items_1.product_id < shop_order_items_5.product_id AND shop_order_items_2.product_id < shop_order_items_5.product_id AND shop_order_items_3.product_id < shop_order_items_5.product_id AND shop_order_items_4.product_id < shop_order_items_5.product_id))


    INNER JOIN mysql_heroku_app_db.product AS product_5 ON shop_order_items_5.product_id = product_5.id)
