...
explore: facebook_ads {
  ...
  join: facebook_ad_insights {
    type: left_outer
    sql_on: ${facebook_ads.id} = ${facebook_ad_insights.ad_id} ;;
    relationship: many_to_one
  }
}
...
explore: facebook_ad_insights {
  join: facebook_ads {
    type: left_outer
    sql_on: ${facebook_ad_insights.ad_id} = ${facebook_ads.id} ;;
    relationship: many_to_one
  }

  join: facebook_adsets {
    type: left_outer
    sql_on: ${facebook_ad_insights.adset_id} = ${facebook_adsets.id} ;;
    relationship: many_to_one
  }

  join: facebook_campaigns {
    type: left_outer
    sql_on: ${facebook_ad_insights.campaign_id} = ${facebook_campaigns.id} ;;
    relationship: many_to_one
  }
}
